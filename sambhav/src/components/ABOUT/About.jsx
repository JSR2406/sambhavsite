        ...
        <section className="cards">
          ...
          <article className="card card--orange">
            ...
            <p>
              ...
              Sambhav 3.0 bridges the gap between academia and industry through
              hands-on workshops, interactive sessions, and showcases of
              cutting-edge technologies. Our mission is to empower participants
              to unlock their full potential and prepare them to lead in a
          ...
          <div className="inspo-inner">
            ...
            <div className="inspo-text">
              <p className="inspo-quote">
                "Sambhav 3.0 draws inspiration from Sir M. Visvesvaraya, India's
                legendary engineer and statesman, whose vision, discipline, and
                dedication laid the foundation for technological progress. His
                legacy continues to inspire generations of engineers."
              </p>
            </div>
          </div>
        </section>
